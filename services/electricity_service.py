...
class ElectricityService:
    ...
    def get_electricity_price(self, hour: Optional[int] = None, 
                            date: Optional[datetime] = None,
                            include_tomorrow: bool = True) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            if include_tomorrow:
                ...
                if not tomorrow_prices.get('error') and hour + 1 in tomorrow_prices['prices']:
    ...
    def format_price_message(self, price_data: Dict[str, Any]) -> str:
        ...
        if today_price:
            ...
            message_parts.append(f"⚡ Tänään {date_str} klo {hour:02d}: {price_snt:.2f} snt/kWh (ALV 25,5%)")
        ...
        if tomorrow_price:
            ...
            message_parts.append(f"⚡ Huomenna {tomorrow_date} klo {hour:02d}: {price_snt:.2f} snt/kWh (ALV 25,5%)")
    ...
    def parse_command_args(self, args: List[str]) -> Dict[str, Any]:
        ...
        try:
            ...
            result['error'] = "Virheellinen komento! Käytä: !sahko [huomenna] [tunti] tai !sahko tilastot"
