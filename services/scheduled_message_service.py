...
class ScheduledMessageService:
    ...
    def schedule_message(
        ...
        timer_thread = threading.Timer(delay, self._send_scheduled_message, args=[message_id])
    ...
    def cleanup_expired(self):
        ...
        if expired_ids:
            self.logger.info(f"Cleaned up {len(expired_ids)} expired scheduled messages")
