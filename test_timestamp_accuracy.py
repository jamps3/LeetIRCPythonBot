...
def test_timestamp_accuracy():
    ...
    for i in range(10):
        ...
        print(f"  Message {i+1:2d}: {timestamp} (captured in {processing_time_ns:,} ns)")
    ...
    print(f"    Total processing time: {total_delay:,} ns ({total_delay/1_000_000:.2f} ms)")
    ...
    difference_ns = abs(delayed_ns - immediate_ns) if delayed_ns > immediate_ns else (1_000_000_000 - immediate_ns + delayed_ns)
