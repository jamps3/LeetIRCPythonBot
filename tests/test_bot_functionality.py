...
def test_nanoleet_detector_ultimate():
    ...
    try:
        ...
        message = detector.format_achievement_message(
            "testuser", ultimate_timestamp, level
        )
        ...
        try:
            ...
            with patch("bot_manager.DataManager") as mock_dm:
                with patch("bot_manager.get_api_key", return_value=None):
                    with patch(
                        "bot_manager.create_crypto_service", return_value=Mock()
                    ):
                        with patch(
                            ...
                            with patch(
                                ...
                                with patch(
                                    ...
                                    with patch(
                                        ...
                                        result = bot_manager.toggle_tamagotchi(
                            ...
                            with patch(
                                ...
                                with patch(
                                    ...
                                    test_urls = [
                                        ...
                                        (
                                            "https://youtube.com/watch?v=5nM6T3KCVfM",
                                            True,
                                        ),
                                        # Short YouTube URLs
                                        ...
                                        # Mobile YouTube URLs
                                        (
                                            "https://m.youtube.com/watch?v=5nM6T3KCVfM",
                                            True,
                                        ),
                                        # YouTube Music URLs
                                        (
                                        ...
                                        # Embed URLs
                                        (
                                            "https://www.youtube.com/embed/5nM6T3KCVfM",
                                            True,
                                        ),
