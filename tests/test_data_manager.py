...
class TestDataManager:
    ...
    def setup_method(self):
        ...
        self.data_manager = DataManager(data_dir=self.temp_dir, state_file=self.state_file)
    ...
    def test_ensure_data_files_creates_structure(self):
        ...
        data_manager = DataManager(data_dir=self.temp_dir, state_file=os.path.join(self.temp_dir, "state.json"))
