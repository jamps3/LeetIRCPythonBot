...
class TestKraksCommand(unittest.TestCase):
    ...
    def test_kraks_command_with_data(self):
        ...
        # Add some test data
        alice_matches = self.drink_tracker.process_message(server_name, "alice", "krak krak krak")
        bob_matches = self.drink_tracker.process_message(server_name, "bob", "narsk narsk")
        charlie_matches = self.drink_tracker.process_message(server_name, "charlie", "parsk")
    ...
    def test_kraks_command_drink_word_patterns(self):
        ...
        drink_words = ["krak", "kr1k", "kr0k", "narsk", "parsk", "tlup", "marsk", "tsup", "plop", "tsirp"]
