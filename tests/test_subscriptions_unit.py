...
class TestSubscriptionsEnhanced(unittest.TestCase):
    ...
    def test_validate_and_clean_data(self):
        ...
        valid_data = {
            ...
            "server2": {
                "user123": ["varoitukset", "onnettomuustiedotteet"]
            }
        }
    ...
    def test_load_subscriptions_corrupted_json(self):
        ...
        backup_files = [f for f in os.listdir(os.path.dirname(self.temp_file.name)) 
    ...
    def test_get_user_subscriptions(self):
        ...
        self.assertEqual(sorted(subscriptions), sorted(["varoitukset", "onnettomuustiedotteet"]))
    ...
    def test_atomic_writes(self):
        ...
        temp_files = [f for f in os.listdir(os.path.dirname(self.temp_file.name)) 
                     if f.endswith('.tmp')]
