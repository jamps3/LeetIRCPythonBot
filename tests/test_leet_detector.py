...
def test_ignore_trivial_1337_at_13_37_only():
    d = LeetDetector()
    # Time is 13:37 with seconds that don't contain 1337 and no nano 1337
    ts = "13:37:42.987654321"
...
def test_detect_nano_leet_when_only_nano_contains_1337():
    d = LeetDetector()
    # Time is 13:37 but seconds do not contain 1337; nano has 1337
    ts = "13:37:42.000133700"
    result = d.detect_leet_patterns(ts)
    level = d.determine_achievement_level(result)
