...
class TestAdminCommands(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # Patch get_config
        self.config_patcher = patch('commands_admin.get_config', return_value=self.mock_config)
    ...
    def test_quit_command_console_triggers_shutdown(self):
        ...
        self.assertTrue(self.stop_event.is_set(), "Stop event should be set after console quit")
        self.assertIn("🛑 Shutting down bot", response, "Response should contain shutdown message")
    ...
    def test_quit_command_irc_sends_quit_and_triggers_shutdown(self):
        ...
        # Verify shutdown was triggered
        self.assertTrue(self.stop_event.is_set(), "Stop event should be set after IRC quit")
        
        # Verify logging
        self.mock_logger.assert_called_once_with("Admin quit with message: bye everyone", "INFO")
    ...
    def test_join_command_irc(self):
        ...
        self.mock_logger.assert_called_once_with("Admin joined channel #testchannel", "INFO")
    ...
    def test_join_command_irc_with_key(self):
        ...
        context = self.MockContext(["testpass123", "#private", "secretkey"], is_console=False)
        response = commands_admin.join_command(context, self.bot_functions)
    ...
    def test_part_command_irc(self):
        ...
        self.mock_logger.assert_called_once_with("Admin left channel #leavechannel", "INFO")
    ...
    def test_nick_command_irc(self):
        ...
        self.mock_logger.assert_called_once_with("Admin changed nick to coolbot", "INFO")
        self.assertEqual(response, "Changed nick to coolbot")

    def test_raw_command_irc(self):
        """Test raw command over IRC."""
        context = self.MockContext(["testpass123", "MODE", "#channel", "+o", "user"], is_console=False)
    ...
    def test_no_irc_connection_error_handling(self):
        ...
        commands_to_test = [
            ...
            (commands_admin.raw_command, ["testpass123", "MODE", "#test", "+o", "user"]),
        ]
