...
def test_command_registry_creation():
    ...
    try:
        ...
        assert isinstance(global_registry, CommandRegistry), "Should return CommandRegistry instance"
...
def test_command_registration():
    ...
    try:
        from command_registry import CommandRegistry, CommandInfo, FunctionCommandHandler
...
def test_command_aliases():
    ...
    try:
        ...
        info = CommandInfo(name="test", description="Test command", aliases=["t", "testing"])
...
def test_command_error_handling():
    ...
    try:
        from command_registry import CommandRegistry, CommandInfo, CommandContext, FunctionCommandHandler
