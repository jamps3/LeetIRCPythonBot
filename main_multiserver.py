...
Usage:
    python main_multiserver.py [options]
...
def parse_arguments():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  python main_multiserver.py                     # Start with default settings
  python main_multiserver.py -l DEBUG           # Start with debug logging
  python main_multiserver.py -nick MyBot        # Start with custom nickname
  python main_multiserver.py -api               # Show API keys (for debugging)
