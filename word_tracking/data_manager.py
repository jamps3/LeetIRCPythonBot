...
class DataManager:
    ...
    def _ensure_data_files(self):
        ...
        self._create_file_if_not_exists(self.general_words_file, general_words_structure)
        self._create_file_if_not_exists(self.tamagotchi_state_file, tamagotchi_structure)
        self._create_file_if_not_exists(self.privacy_settings_file, privacy_structure)
    
    def _create_file_if_not_exists(self, file_path: str, default_structure: Dict[str, Any]):
        ...
        try:
            ...
            for nick, words in old_data.items():
                general_words_data["servers"][default_server]["nicks"][nick] = {
                    ...
                    "total_words": sum(words.values()) if isinstance(words, dict) else 0
                }
                migrated_count += 1
            ...
            print(f"Successfully migrated {migrated_count} users. Old file backed up to {backup_path}")
            return True
